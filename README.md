...
- Type 1 `.pfb` and `.pfa` fonts are resolved next to the document, through TeX map files, and through `kpsewhich`; unsupported or missing outlines fall back to PK bitmaps, then GF bitmaps, then AppKit fonts.
